  ...
  return (
    <div className={'min-h-screen flex flex-1 flex-col gap-4 p-6 md:p-10'}>
      ...
      <div className={'flex flex-1 items-center justify-center'}>
        <div
          className={
            'w-full max-w-6xl overflow-hidden rounded-3xl bg-white shadow-2xl ring-1 ring-black/5 grid grid-cols-2'
          }
          style={{
        ...
        >
          ...
          >
            <div
              ...
              style={{
                backgroundImage:
                  "url('http://localhost:4566/furniture-wholesale-bucket/auth/background.png')",
              }}
            />
            <div
              aria-hidden
            ...
            <div className={'relative flex items-center gap-2'}>
              ...
              <span className={'text-sm font-medium'}>Furniture.wholesale</span>
            </div>
