  ...
  return (
    ...
    >
      <div className={'relative rounded-[30px] overflow-hidden'}>
        ...
        <Badge
          className={
            'absolute top-3 left-3 bg-white text-black text-[11px] font-medium px-3 py-1 rounded-full shadow-sm border-0'
          }
        >
          {category}
        </Badge>
        <button
          onClick={onDelete}
          className={
            'absolute top-3 right-3 w-8 h-8 rounded-full bg-red-100 flex items-center justify-center hover:bg-red-200 transition-colors'
          }
        >
          <ICONS.TrashFigma
            size={14}
