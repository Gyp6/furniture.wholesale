...
import { ArrowRight, Building2, CheckCircle2, ShoppingBag } from 'lucide-react';
...
export function OrderConfirmationPage({ params }: Props) {
  ...
  return (
    <div className={'w-full max-w-4xl mx-auto p-6 space-y-6'}>
      <Card
        className={
          'p-8 rounded-[30px] border-0 shadow-md text-center space-y-4'
        }
      >
        ...
        <p className={'text-muted-foreground max-w-md mx-auto'}>
          Your order has been confirmed. Each supplier has been notified and a
        ...
        <div className={'grid grid-cols-1 sm:grid-cols-3 gap-4 pt-4'}>
          <div className={'bg-neutral-50 rounded-[20px] p-4'}>
            <p
              className={
                'text-xs uppercase tracking-widest text-muted-foreground font-semibold mb-1'
              }
            >
              Order Number
            </p>
                ...
                {subOrder.items.map(item => {
                  ...
                  return (
                    ...
                    >
                      <div
                        className={
                          'relative w-14 h-14 rounded-[10px] overflow-hidden bg-white shrink-0'
                        }
                      >
                        <Image
                          src={imgSrc}
