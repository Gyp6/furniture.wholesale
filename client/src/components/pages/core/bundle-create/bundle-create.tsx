...
import { ArrowLeft, Package, Plus, Search, Upload, X } from 'lucide-react';
...
export function BundleCreatePage() {
  ...
  const addProduct = (product: IProduct) => {
    ...
    setSelectedProducts(prev => [
      ...prev,
      { product, quantity: product.minSellUnits ?? 1 },
    ]);
  };
  ...
  return (
    <div className={'w-full max-w-4xl mx-auto p-6 space-y-6'}>
          ...
          <div className={'flex items-center justify-between'}>
            <div>
              ...
              <p className={'text-sm text-muted-foreground mt-1'}>
                Add at least 2 of your products ({selectedProducts.length}{' '}
                selected)
              </p>
            </div>
              ...
              >
                ...
                <div className={'p-3 space-y-2'}>
                  ...
                  <p className={'text-xs text-muted-foreground'}>
                    $
                    {sp.product.price.toLocaleString('en-US', {
                      minimumFractionDigits: 2,
                    })}{' '}
                    / unit
                  </p>
                  <div className={'flex items-center gap-2'}>
                    ...
                    <div
                      className={
                        'flex items-center gap-2 bg-secondary/10 rounded-full px-3 py-1'
                      }
                    >
                      <button
                        type={'button'}
                        onClick={() =>
                          updateQuantity(sp.product.id, sp.quantity - 1)
                        }
                        className={
                          'text-secondary font-bold text-sm hover:opacity-70 transition-opacity'
                        }
                      >
                        −
                      </button>
            ...
            {productsLoading ? (
              ...
              >
                ...
                <p className={'text-xs mt-1'}>
                  Create products first in your dashboard
                </p>
              </div>
            )}
          </div>
      ...
      >
        <DialogContent
          className={
            'rounded-[30px] p-6 sm:max-w-[640px] max-h-[85vh] flex flex-col'
          }
          showCloseButton={false}
        >
          <DialogHeader>
          ...
          <form
            ...
            className={
              'flex-1 overflow-y-auto space-y-4 min-h-0 max-h-[60vh] pr-1'
            }
          >
            <div>
              ...
              {productForm.formState.errors.title && (
                <p className={'text-sm text-red-500 mt-1'}>
                  {productForm.formState.errors.title.message}
                </p>
              )}
            </div>
            ...
            <div>
              ...
              <Select
                onValueChange={value =>
                  productForm.setValue('categoryId', value)
                }
              ...
              <div className={'grid grid-cols-3 gap-2 mt-1'}>
                {spaces?.map(space => (
                  <Button
                    ...
                    type={'button'}
                    variant={
                      selectedProductSpaces.includes(space.title)
                        ? 'default'
                        : 'outline'
                    }
              ...
              <div className={'flex flex-wrap gap-2 mt-1'}>
                {tags?.map(tag => (
                  <Button
                    ...
                    type={'button'}
                    variant={
                      selectedProductTags.includes(tag.title)
                        ? 'default'
                        : 'outline'
                    }
            ...
            <div>
              ...
              <div className={'grid grid-cols-5 gap-3 mt-1'}>
                {productImagePreviews.map((preview, index) => (
                  ...
                  >
                    ...
                    <button
                      ...
                      className={
                        'absolute top-1 right-1 w-5 h-5 rounded-full bg-red-500 text-white flex items-center justify-center hover:bg-red-600'
                      }
                    >
                      <X className={'w-3 h-3'} />
                    </button>
                ...
                {productImages.length < 5 && (
                  <label
                    className={
                      'aspect-square rounded-xl border-2 border-dashed border-neutral-300 hover:border-secondary transition-colors cursor-pointer flex flex-col items-center justify-center gap-1'
                    }
                  >
