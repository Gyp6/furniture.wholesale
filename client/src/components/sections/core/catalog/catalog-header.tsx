  ...
  return (
    <div className={'flex flex-col gap-8'}>
      <div className={'flex flex-wrap items-center justify-between gap-8'}>
        <h2
          className={
            'text-4xl font-bold tracking-tight text-foreground whitespace-nowrap'
          }
        >
        ...
        <div className={'flex items-center gap-4'}>
          <div className={'relative w-[280px]'}>
            ...
            <Input
              ...
              className={
                'pl-10 h-11 text-sm rounded-full bg-white border border-neutral-200 text-foreground placeholder:text-muted-foreground shadow-none'
              }
            />
          </div>
          <Button
        ...
        <div className={'flex items-center gap-3 flex-wrap'}>
          {ACTIVE_FILTERS.map(filter => (
            <Badge
              ...
              variant={'secondary'}
              className={
                'rounded-full px-4 py-1.5 text-sm flex items-center gap-2 cursor-pointer bg-secondary/10 text-secondary hover:bg-secondary/20 border-0'
              }
            >
