    ...
    <div className="flex flex-col gap-8">
      ...
      <div className="flex items-center justify-between gap-8 flex-wrap">
        <div className="flex items-center gap-3 flex-wrap">
          ...
          <button className="text-sm text-secondary hover:underline underline-offset-2 font-medium">
            Clear all
          </button>
        </div>
        ...
        <div className="flex items-center gap-2 text-sm text-muted-foreground shrink-0">
          Sort by:
          <DropdownMenu>
            <DropdownMenuTrigger className="flex items-center gap-1.5 text-sm font-medium text-foreground outline-none border border-neutral-200 rounded-full px-4 py-2 bg-white hover:bg-neutral-50 transition-colors">
              Curated Popularity <ChevronDown className="w-3.5 h-3.5" />
            </DropdownMenuTrigger>
            <DropdownMenuContent align="end">
              <DropdownMenuItem className="text-sm">Curated Popularity</DropdownMenuItem>
