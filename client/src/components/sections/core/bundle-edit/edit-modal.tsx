...
export function EditItemModal({ open, onOpenChange, onSubmit, onDiscard }: TEditItemModalProps) {
              ...
              <div className="flex flex-col gap-1">
                ...
                <div className="flex items-center gap-2 bg-secondary/10 rounded-full px-3 py-2">
                  <button
                    ...
                    className="text-secondary font-bold hover:opacity-70 transition-opacity"
                  >
                    −
                  </button>
        ...
        <div className="flex flex-col gap-2">
          ...
          <div className="flex items-center gap-2 flex-wrap">
            {categories.map((cat) => (
              <div
                key={cat}
                className="flex items-center gap-1.5 bg-neutral-100 rounded-full px-3 py-1.5 text-xs font-medium"
              >
                {cat}
