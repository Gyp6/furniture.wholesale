...
export function SupplierHero() {
  return (
    <div className="relative w-full overflow-hidden" style={{ height: '442px' }}>
      ...
      <div
        className="absolute bottom-6 left-10 bg-white rounded-2xl p-4 flex items-center gap-3 shadow-lg"
      ...
      <div
        className="absolute right-10 bg-white rounded-2xl p-5 flex flex-col justify-center gap-3 shadow-lg"
      ...
      >
        ...
        <div className="flex items-center gap-2">
          <span className="text-[12px] uppercase tracking-widest text-muted-foreground">Lead Time</span>
          <span className="text-sm font-semibold">{ProfileData.leadTime}</span>
        </div>
        <button className="text-[12px] font-bold uppercase tracking-widest text-secondary underline underline-offset-2 text-left">
