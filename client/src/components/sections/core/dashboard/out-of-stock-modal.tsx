    ...
    >
      ...
      >
        ...
        <p className={'text-sm text-muted-foreground leading-relaxed'}>
          ...
          is no longer available and has been removed from your bundle.
        </p>

        <div
          className={
            'flex items-center gap-3 rounded-2xl border border-neutral-100 p-3'
          }
        >
          <div
