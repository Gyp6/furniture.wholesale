        ...
        <div className={"w-[700px] shrink-0 flex flex-col gap-6"}>
          ...
          <div className={"grid grid-cols-3 gap-4"}>
            {SupplierStatsData.map(stat => (
              <div
                key={stat.label}
                className={"relative rounded-2xl border border-neutral-100 p-5 bg-white min-h-[130px]"}
              >
                {stat.badge && (
                  <span
                ...
                <p className={"text-[14px] uppercase tracking-widest text-muted-foreground mt-1"}>
                  {stat.label}
                </p>
              </div>
            ))}
