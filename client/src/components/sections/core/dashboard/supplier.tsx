...
import { ORDER_STATUS_STYLES, INVENTORY_STATUS_STYLES, CATEGORY_STYLES } from '@/constants/dashboard.const';
import { OrdersData, SupplierStatsData, InventoryData } from '@/shared/data/dashboard';
