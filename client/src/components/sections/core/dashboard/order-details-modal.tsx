...
export function OrderDetailsModal({ open, onOpenChange }: TOrderDetailsModalProps) {
  return (
...
\        <div className="grid grid-cols-3 gap-4 overflow-y-auto max-h-[500px] scrollbar-hide">
          {[...Array(6)].map((_, i) => (
            <OrderCard
              key={i}
