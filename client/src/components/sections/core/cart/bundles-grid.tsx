...
export function PrebuiltBundleSection({
  ...
  return (
    <div className="flex flex-col gap-3">
      ...
      <div className="bg-white rounded-[60px] p-5 flex flex-col gap-5 shadow-[0_8px_40px_rgba(0,0,0,0.06)]">

        <div className="flex items-start justify-between gap-5">

          <div className="shrink-0 pt-1">
            <div className="flex items-center gap-2 bg-secondary/10 rounded-full px-3 py-1.5">
              <ICONS.Bundles size={16} color="currentColor" className="text-secondary" />
              <span className="text-xs font-bold text-secondary">{itemsCount} ITEMS</span>
            </div>
          </div>
