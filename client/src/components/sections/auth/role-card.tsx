...
export const RoleCard = ({ value, title, description, label, image, onClick }: Props) => {
  return (
    <button
      type={'button'}
    ...
    >
      ...
      <div className={"relative flex flex-col gap-4 p-5"}>
        ...
        <div className={"mt-1 flex items-center justify-center rounded-full bg-white px-4 py-2.5"}>
