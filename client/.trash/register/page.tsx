...
export const metadata: Metadata = {
  ...
  description:
    'Join Gyp6.sale — the B2B furniture marketplace for architectural procurement professionals.',
};
  ...
  return (
    <div className={'h-screen overflow-hidden bg-white flex flex-col'}>
      ...
      <div className={'flex flex-1 items-center justify-center px-4'}>
        <div
          className={
            'w-full overflow-hidden rounded-3xl bg-white shadow-2xl ring-1 ring-black/5'
          }
          style={{
            maxWidth: 1000,
        ...
        >
          <aside
            className={
              'relative flex flex-col justify-between overflow-hidden bg-[#1A1A2E] p-10 text-white'
            }
          >
            <div
              aria-hidden
            ...
            <div className={'relative flex items-center gap-2'}>
              <div
                className={
                  'flex size-8 items-center justify-center rounded-full bg-white text-[#1A1A2E]'
                }
              >
          ...
          <section
            className={'flex flex-col justify-center p-6 overflow-hidden'}
          >
            <RegisterForm />
          </section>
        </div>
